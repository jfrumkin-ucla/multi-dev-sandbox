...
#    Then I should get a "403" HTTP response
  ...
  @api
  Scenario: SiteFarm node article metatag defaults should be locked
    Given I am at "user/logout"
    And I am logged in as a user with the "Site Manager" role
    And I am at "admin/config/search/metatag"
#    Then  I should see "Locked" in the "Admin Content" region
    Then I should see a ".locked" element
    Given I am on "admin/config/search/metatag/node__sf_article?destination=/admin/config/search/metatag"
    Then I should get a "403" HTTP response

  @api
  Scenario: SiteFarm node event metatag defaults should be locked
    Given I am at "user/logout"
    And I am logged in as a user with the "Site Manager" role
    And I am at "admin/config/search/metatag"
#    Then  I should see "Locked" in the "Admin Content" region
    Then I should see a ".locked" element
    Given I am on "admin/config/search/metatag/node__sf_event?destination=/admin/config/search/metatag"
    Then I should get a "403" HTTP response

  @api
  Scenario: SiteFarm node page metatag defaults should be locked
    Given I am at "user/logout"
    And I am logged in as a user with the "Site Manager" role
    And I am at "admin/config/search/metatag"
#    Then  I should see "Locked" in the "Admin Content" region
    Then I should see a ".locked" element
    Given I am on "admin/config/search/metatag/node__sf_page?destination=/admin/config/search/metatag"
    Then I should get a "403" HTTP response

  @api
  Scenario: SiteFarm node person metatag defaults should be locked
    Given I am at "user/logout"
    And I am logged in as a user with the "Site Manager" role
    And I am at "admin/config/search/metatag"
#    Then  I should see "Locked" in the "Admin Content" region
    Then I should see a ".locked" element
    Given I am on "admin/config/search/metatag/node__sf_person?destination=/admin/config/search/metatag"
    Then I should get a "403" HTTP response

  @api
  Scenario: SiteFarm node photo gallery metatag defaults should be locked
    Given I am at "user/logout"
    And I am logged in as a user with the "Site Manager" role
    And I am at "admin/config/search/metatag"
#    Then  I should see "Locked" in the "Admin Content" region
    Then I should see a ".locked" element
    Given I am on "admin/config/search/metatag/node__sf_photo_gallery?destination=/admin/config/search/metatag"
    Then I should get a "403" HTTP response
