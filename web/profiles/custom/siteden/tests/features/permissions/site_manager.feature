...
#    Then I should get a "200" HTTP response
#    Given I am on "admin/config/services/google-analytics"
#    Then I should get a "200" HTTP response
...
# TODO: see why this is failing and re-enable.
#  @api
...
#    Then I should not see the link "admin_user"
  ...
  @api
  Scenario: Site Manager cannot access robots.txt interface
    Given I am on "admin/config/search/robotstxt"
    Then I should get a "403" HTTP response
