...
class FormAlterTest extends UnitTestCase {
  ...
  /**
   * Tests the createRelatedContentGroup() method.
   */
  public function testCreateRelatedContentGroup() {
    $this->advancedTabsGroup->loadForm([])->shouldBeCalled();
    $this->advancedTabsGroup->createGroup('related', 'Related Content', 94)->shouldBeCalled();
    $this->advancedTabsGroup->save()->shouldBeCalled();

    $form = [];
    $this->helper->createRelatedContentGroup($form);
  }
