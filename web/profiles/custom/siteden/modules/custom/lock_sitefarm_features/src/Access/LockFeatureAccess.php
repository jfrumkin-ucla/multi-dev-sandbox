...
class LockFeatureAccess implements AccessInterface {
  ...
  /**
   * Meta defaults which should be restricted.
   *
   * @var array
   */
  protected $lockedMetaDefaults = [];
   ...
   * @return array
   */
  public function getLockedMetaDefaults() {
    $this->lockedMetaDefaults = $this->configFactory
      ->get('lock_sitefarm_features.settings')
      ->get('locked_meta_defaults');

    return $this->lockedMetaDefaults;
  }
  ...
  public function restrictedPath() {
    ...
    $parameters = [
      ...
      'view' => 'lockedViews',
      'metatag_defaults' => 'lockedMetaDefaults',
    ];
