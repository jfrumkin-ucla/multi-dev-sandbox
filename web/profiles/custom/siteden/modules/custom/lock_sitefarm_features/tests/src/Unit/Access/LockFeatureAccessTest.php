...
class LockFeatureAccessTest extends UnitTestCase {
  ...
  /**
   * @var \Drupal\lock_sitefarm_features\Access\LockFeatureAccess
   */
  protected $access;
  ...
  protected function setUp(): void {
    ...
    $parameters = [
      ...
      'meta_defaults' => 'node__sf_article',
    ];
  ...
  /**
   * Tests getLockedMetaDefaults().
   */
  public function testGetLockedMetaDefaults() {
    $return = $this->access->getLockedMetaDefaults();
    $this->assertContains('node__sf_article', $return);
  }
